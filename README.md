...
<p align="center">
  <img src="frontend/images/icon2.png" alt="IsdaSure" width="820" style="max-width:100%; height:auto; object-fit:cover; border-radius:8px;" />
</p>

# IsdaSure

> On-chain micro-insurance for coastal communities — Soroban smart contracts on Stellar Testnet.
...
- Group management: create groups, join requests, member approvals
...
```
IsdaSure/
├─ backend/                # Express API, services, file-backed data
├─ contract/               # Soroban Rust smart contract source & tests
├─ frontend/               # React + Vite frontend (Freighter integration)
